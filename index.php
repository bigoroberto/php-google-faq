...
$faqs = [
  [
    'question' => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio? <br><br>",
...
/*   [
    ...
    Scopri quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.<br><br><br><br>",
  ],
  [
    'question' => "Perché il mio account è associato a un paese?<br><br>",
  ...
  [
    'question' => "Stabilire il paese associato al tuo account<br><br>",
